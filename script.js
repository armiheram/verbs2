...
// constantes que mostraran los verbos
...
// Respuesta correcta y 3 erroneas
let answerRoullete = [0,1,1,1];
let everyNumberOfVerbs = [];

let rightAnswer; // Cada respuesta correcta
...
// Empezamos en la ultima posicion
...
//funcion de respuesta incorrecta
...
function ponerVerbo(){
  ...
  //trae la foto y la acomoda a dimensiones
